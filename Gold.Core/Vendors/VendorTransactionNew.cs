...
namespace Gold.Core.Vendors
{
    ...
    /// </summary>
    public class VendorTransactionNew
    {
        /// <summary>
        /// db id
        /// </summary>
        ...
        public VendorTransactionNew(string refId, Guid source, Guid dest, decimal grams, decimal price, string comment)
        {
            //TransactionId = GetId();
