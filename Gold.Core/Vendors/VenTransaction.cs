...
namespace Gold.Core.Vendors
{
    ...
    public class VenTransaction
    {
        ...
        /// </summary>
        public decimal? GercekKur { get; set; }
        /// <summary>
        /// kt execution ref if any
        /// </summary>
        public string TamamlanmisKTreferans { get; set; }
        /// <summary>
        /// arbitrary comments
        /// </summary>
        public string ExtraBilgi { get; set; }
        ...
        public static int GetId()
        {
            ...
            var subid = (int) (timeDiff.TotalHours  * timeDiff.TotalDays);
            var val = IdNumber.Value;
            IdNumber = val + 1;
            return val * subid % 100000000; 
        }

        private VenTransaction() { }
        ...
        public VenTransaction(string refId, Guid source, Guid dest, decimal grams, decimal price, string comment, decimal kur)
        {
